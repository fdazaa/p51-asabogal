  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['randomization'] = BaseFieldDefinition::create('list_integer')
      ...
      ->setSetting('allowed_values', [
        ...
        1 => 'Random order',
        2 => 'Random questions',
        3 => 'Categorized random questions for TIE platfrom',
...
<strong>Aleatorio TIE basado en Matriz del Marco de Procesos</strong> - La sumatoria debe ser igual al numero de preguntas aleatorias<br>")
  ...
  function buildCategorizedQuestionList()
  {
                    ...
                    if ($clasificacion == 'P') {
                      ...
                      if ($tamano_alto < $questions_numbers_p) {
                        ...
                        if ($tamano_alto == 1) {
                          ...
                          //dpm('alto llenar');
                          $keys = array_rand($questions_alto, $tamano_alto);
                          //dpm($key, 'KEY qa');
                          foreach ($keys as $key){
                            $total_questions[]=$questions_alto[$key];
                          }

                          //dpm($total_questions,'Total question llenado alto');
                        }

                        if ($tamano_medio < $diff_ap) {
                          //dpm('MEDIO NO COMPLETA');
                          ...
                          if ($tamano_medio == 1) {
                            ...
                            if ($diff_ap == 1) {
                              ...
                              //dpm($total_questions, 'Total questions completa medio');
                            }
                          }
                        }
                      } else {
                      ...
                      //dpm($total_questions,'total questions P');
    ...
    //dpm($total_questions,'total question complete');
    return $total_questions;
  }
